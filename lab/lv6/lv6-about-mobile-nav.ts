// /lab/lv6 — mobile-only addition: once the About iframe's final "NEXT
// CHAPTER" panel scrolls into view on a phone-width screen, a hamburger
// icon automatically appears (no tap needed) at the top-right of the
// screen, since that panel — unlike the hero panel at the very top — has
// no nav bar of its own to open the menu from otherwise.
//
...
// position), reaching in from lv6's own script the same way
...
// breakpoint the rest of lv6's mobile-specific behaviour uses, and does
