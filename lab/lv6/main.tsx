...
console.log('%clab/lv6 build 2026-09-11 (copy of main site + About transition)', 'color:#8fb8ea;font-weight:600');
...
if (smMount) {
  const smItems = [
    // lv6-only: real "About" link (elsewhere on the main site this is
    // '#about', an inert placeholder — there's no #about section on this
    // page to jump to). lv6-transition.ts intercepts every a[href="/about"]
    // via delegation, including this one once the menu renders it, so
    // tapping it from the mobile hamburger plays the same transition the
    // desktop pills/hero card/footer link already trigger.
