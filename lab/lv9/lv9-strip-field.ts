// /lab/lv9 — hero background: a curtain of vertical strips tiled edge to
...
// it loaded. Still isolated to lab/lv9's own bundle only; nothing here is
// imported by (or affects) any other route. See main.ts for how this
// pauses (setHeroActive(false)) the instant the flip to page 2 completes
// — there's no game here to hand off to (this is a copy of lv8's hero +
// transition + page-2 figure section only, see chat reply), just page 2
// itself taking over.
import * as THREE from 'three';

const canvas = document.getElementById('lv9-strip-field') as HTMLCanvasElement | null;
const container = document.getElementById('lv9-hero') as HTMLElement | null;
